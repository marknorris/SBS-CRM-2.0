  ...
  didFailWithError:(NSError *)error
{
    ...
    if([delegate respondsToSelector:@selector(fetchXMLError::)])
    {
        [delegate fetchXMLError:@"Error fetching data from the server":self];
    }
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    else if ([delegate respondsToSelector:@selector(fetchXMLError::)]) 
    {
        NSLog(@"error: %@", error.description);
        [delegate fetchXMLError:@"Error fetching data from the server":self];
    }
